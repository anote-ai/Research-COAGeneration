...
FILES = (
    ...
    "experiments/aaai2027/run_executable.py",
    "experiments/aaai2027/run_ablations.py",
    "experiments/aaai2027/plot_executable.py",
    "experiments/aaai2027/run_sensitivity.py",
    "experiments/aaai2027/check_paper_results.py",
    "tests/test_executable_metarouter.py",
    "papers/aaai2027/main.tex",
    "papers/aaai2027/references.bib",
)

DIRECTORIES = (
    "results/aaai2027/executable",
    "results/aaai2027/ablations",
    "results/aaai2027/challenge",
    "results/aaai2027/sensitivity",
)
...
def main() -> None:
    ...
    output = root / "papers/aaai2027/submission/code_data_supplement.zip"
    ...
    supplement = root / "papers/aaai2027/supplement"
    supplement_files = {
