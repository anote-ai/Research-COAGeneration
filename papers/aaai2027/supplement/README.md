...
python experiments/aaai2027/run_sensitivity.py
python experiments/aaai2027/plot_executable.py
python experiments/aaai2027/check_paper_results.py
...
- `experiments/aaai2027/`: main run, ablations, plotting, and result checks
- `tests/`: focused executable benchmark tests
- `results/aaai2027/`: reported task-level traces and aggregate artifacts
