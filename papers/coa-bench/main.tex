...
The implementation, experiment script, and raw results are available in this repository at \path{experiments/coa_bench_experiment.py} and \path{results/coa-bench/main/}.
