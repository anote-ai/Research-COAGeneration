...
\begin{itemize}
    \item a formal adversarial COA-generation setup connecting Match Effectors, Generate BattleCOA, and best-response evaluation while keeping BattleCOA DecisionFunctions distinct from benchmark metrics;
