...
- `results/coa/coa-bench/main/rows.csv`: per-scenario single, quality-greedy, and doctrine-aware response results.
- `results/coa/coa-bench/main/summary.csv`: bootstrap confidence intervals for the manuscript metrics.
- `results/coa/coa-bench/main/budget_curve.csv`: response-budget sweep for `k = 1, 2, 4, 8, 16`.
- `results/coa/coa-bench/main/council_rows.csv`: multi-agent council traces and diagnostics.
- `results/coa/coa-bench/main/terrain_summary.csv`: per-template averages for scenario-family inspection.
- `results/coa/coa-bench/main/details.json`: run metadata and headline rates.
